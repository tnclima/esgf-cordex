...
path_out = "/home/climatedata/temp-esgf/wget/"
...
# data_todo1 = pd.read_csv("data-raw/to-download1.csv")
...
data_todo2 = pd.read_csv("data-raw/to-download2.csv")
...
data_todo2.rename(columns={"downscale_realisation": "bias_adjustment"}, inplace=True)
