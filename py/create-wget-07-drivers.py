...
path_out = "/home/climatedata/temp-eur11/wget-drivers/"
...
data_todo1 = pd.read_csv("data-raw/to-download8-drivers.csv")
...
for i in range(len(data_todo1)):
  ...
  if not os.path.exists(file_wget_path):
    ...
    except (IndexError, urllib3.exceptions.ReadTimeoutError):
      print("Error: " + str(data_todo1.iloc[i].to_list()))
